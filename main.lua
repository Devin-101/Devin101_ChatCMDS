Citizen.CreateThread(function()
    ...
    TriggerEvent('chat:addSuggestion', '/mdt', 'Runs Person Name in the CAD/MDT')
    TriggerEvent('chat:addSuggestion', '/src', 'Searches Players Car')
    TriggerEvent('chat:addSuggestion', '/srp', 'Searches Person For Anything on them')
